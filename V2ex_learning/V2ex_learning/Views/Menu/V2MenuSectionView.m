...
static CGFloat const kAvatarHeight = 70.f;
...
- (void)configureProfileView {
    ...
    if ([V2DataManager manager].user.isLogin) {
        [self.avatarImageView sd_setImageWithURL:[NSURL URLWithString:[V2DataManager manager].user.member.memberAvatarLarge] placeholderImage:[UIImage imageNamed:@"avatar_default"]];
